# Internet & Web Tech Guide: HTML, CSS, JS, PHP, Hosting (AWS/XAMPP), and Core Concepts
---
## Table of Contents 
1. [HTML: Structuring the Web](#html-structuring-the-web)
2. [CSS: Styling the Web](#CSS-Styling-the-Web)
3. [JavaScript: Adding Interactivity](#JavaScript-Adding-Interactivity)
4. [PHP: Server-Side Scripting](#PHP-Server-Side-Scripting)
5. [Hosting: Deploying Your Web Application](#Hosting-Deploying-Your-Web-Application)
6. [Core Web Development Concepts](#Core-Web-Development-Concepts)
---
