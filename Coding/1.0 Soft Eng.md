# Complete Software Engineering Guide: OOP, Design, UML, Sockets, Principles, and Concepts {#complete-software-engineering-guide-oop-design-uml-sockets-principles-and-concepts}
...
- Astah
### Lollipop Diagrams {#lollipop-diagrams}
...
## UML diagrams mentioned in the guide, providing more detail on each: {#uml-diagrams-mentioned-in-the-guide-providing-more-detail-on-each}
...
#### Socket Concepts {#socket-concepts}
...
#### Socket Programming Steps {#socket-programming-steps}
